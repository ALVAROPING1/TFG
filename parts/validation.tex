...
\newcommand{\evalres}{
    \graphicfigure[0.55]{eval/\arabic{eval}-new}{Evaluación \arabic{eval} - Compilador nuevo}
    \graphicfigure[0.55]{eval/\arabic{eval}-old}{Evaluación \arabic{eval} - Compilador actual}
    \graphicfigure[0.55]{eval/\arabic{eval}-as}{Evaluación \arabic{eval} - GNU as}
    \stepcounter{eval}
}
