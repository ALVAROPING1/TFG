...
que \gls{GAS} no produce ningún error en este caso, pero un análisis del código
...
destacar que \gls{GAS} no produce ningún error en este caso, pero un análisis
del código generado indica que añade la codificación binaria de las
instrucciones como si fueran datos.
