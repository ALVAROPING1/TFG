...
% TODO: lenguaje de programación -> glossary
...
que obtener un alto rendimiento es más importante. Un ejemplo de esto se puede
ver en la figura \figureref{error_gas}.

% TODO:
% \graphicfigure{error_gas}{Mensaje de error del \gls{assembler} de GNU}
