...
soporta \gls{compilation} condicional, definición de símbolos con valores
arbitrarios, ni \glspl{macro}. Además, sus \glspl{expression} aritméticas
soportan menos operadores que \gls{GAS}.
...
condicional, definición de símbolos con valores arbitrarios, y uso de bucles
para la generación de código. Además, utiliza la sintaxis de Intel. Cabe
destacar su potente sistema de \glspl{macro}, que permite \glspl{macro}
variadicas, sobrecarga (definición de múltiples \glspl{macro} con el mismo
nombre) según el número de argumentos, etiquetas locales a la \gls{macro}, y
múltiples funcionalidades para procesar los argumentos.
