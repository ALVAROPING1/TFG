...
\begin{component}{Lexer}
    ...
    RS-F-directivas-datos, RS-F-escape, RS-F-floats, RS-F-comentarios, RS-F-constantes, RS-F-expr-operadores, RS-F-errores-base} % Origen
...
\begin{component}{Parser de expresiones}
    ...
    {RS-F-floats, RS-F-constantes, RS-F-expr-operadores, RS-F-expr-instruccion, RS-F-expr-directiva, RS-F-errores-base} % Origen
...
\begin{landscape}
    \traceabilityTable[p]{trazability-comp-f}{^[^R]}{^RS\37-F}
