...
\begin{component}{Lexer}
    ...
    {FN-compilar-instrucciones, FN-compilar-pseudo, FN-directivas, FN-directivas-datos, FN-utf8, FN-escape, FN-floats, FN-comentarios, FN-constantes, FN-expr-operadores, FN-errores-base} % Origen
...
\begin{landscape}
    \traceabilityTable[p]{trazability-comp-f}{^\37D+$}{^RS\37-FN}
...
Como se especificó en \subsectionref{compiler}, el traductor realizará varias
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        y se almacena en una \gls{symbol table}.
    \end{itemize}
