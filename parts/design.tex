...
Según los requisitos \reqref[]{RS-NF-chrome} a \reqref[]{RS-NF-JS}, el sistema
...
sobrecoste de una máquina virtual o intérprete. El \reqref{RS-NF-velocidad}
...
como pide el \reqref{RS-NF-JS}. Existen herramientas como Emscripten (C/C++)
...
Sin embargo, el \reqref{RS-NF-def-instrucciones} indica que la definición de la
...
\reqref{RS-F-errores-base}, y a aplicar estrategias de recuperación de errores
...
\reqref{RS-F-referencias}. Si el compilador escanease el código secuencialmente,
...
\begin{component}{Lexer}
    ...
    {RS-F-compilar-instrucciones, RS-F-compilar-pseudo, RS-F-directivas, RS-F-directivas-datos, RS-F-floats, RS-F-comentarios, RS-F-constantes, RS-F-errores-base} % Origen
...
\begin{component}{Parser de expresiones}
    ...
    {RS-F-floats, RS-F-constantes, RS-F-expr-instruccion, RS-F-expr-directiva, RS-F-errores-base} % Origen
...
\begin{component}{Parser}
    ...
    {RS-F-compilar-instrucciones, RS-F-compilar-pseudo, RS-F-directivas, RS-F-directivas-datos, RS-F-num-etiquetas, RS-F-errores-base} % Origen
...
\begin{component}{Parser de instrucciones}
    ...
    {RS-F-compilar-instrucciones, RS-F-compilar-pseudo, RS-F-mult-defs-instruccion, RS-F-errores-base} % Origen
...
\begin{component}{Evaluador de pseudo-instrucciones}
    ...
    {RS-F-compilar-pseudo, RS-F-errores-base} % Origen
...
\begin{component}{Compilador}
    ...
    {RS-F-compilar-instrucciones, RS-F-compilar-pseudo, RS-F-directivas, RS-F-secciones, RS-F-directivas-datos, RS-F-strings, RS-F-tamaño-ints, RS-F-floats, RS-F-alineamiento, RS-F-bibliotecas, RS-F-num-etiquetas, RS-F-referencias, RS-F-constantes, RS-F-mult-defs-instruccion, RS-F-errores-base, RS-F-bigints} % Origen
...
El \reqref{RS-F-mult-defs-instruccion} indica que una instrucción puede tener
...
usuario, como pide el \reqref{RS-F-errores-base}. % TODO: mencionar simplificación saltos de línea?
