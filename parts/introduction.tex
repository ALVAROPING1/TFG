...
\glsdisp{programming language}{lenguajes}, y determina las consecuencias del uso
...
CREATOR \parencite{CREATOR} es un simulador genérico desarrollado por el grupo
